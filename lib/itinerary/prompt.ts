...
4. TRANSPORTE é preferência, não regra rígida: walk prioriza lugares até ~2,5 km, mas pode incluir 1-2 ícones mais distantes sinalizando carro/Uber; car prioriza até ~20 km; mixed equilibra próximos e médios. distance_from_property deve refletir o meio de deslocamento. Se não houver distância confiável, omita o campo.
